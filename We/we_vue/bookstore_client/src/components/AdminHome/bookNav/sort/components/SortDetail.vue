      ...
      <div class="first_tab">
        <el-form ref="bookSort" :model="bookSort" :rules="rules" label-width="80px">
          ...
          <el-form-item label="排序" prop="grade">
            <el-input v-model.number="bookSort.grade" @keyup.native="proving"></el-input>
          </el-form-item>
          <el-form-item>
...
<script>
  import {reqGetUpperName,reqGetBookSort,reqAddBookSort,reqModifyBookSort,reqGetBookSortById} from "../../../../../api/sort";
  ...
  export default {
        ...
        created() {
            if(this.isEdit){
                ...
                if(!this.isFirst){
                    reqGetBookSortById(tempId).then(response=>{
                        console.log(tempId);
                        console.log(response.bookSort);
