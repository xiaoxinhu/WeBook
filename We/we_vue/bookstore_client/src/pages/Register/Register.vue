          ...
          <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="demo-ruleForm" size="medium">
            ...
            <el-form-item>
              <el-button type="primary" @click="submitForm('ruleForm')" style="width: 100%"
               class="register_button">注册</el-button>
            </el-form-item>
            <!-- <el-form-item>
              <center><span class="register_agree">已阅读并同意：浮游书店 用户协议</span></center>
            </el-form-item> -->
          </el-form>
        </div>
      </div>
...
<style >
    .content_register .el-input__inner {
         background-color: transparent !important;
        border-radius: 20px !important;
        color: #fff !important;
        height: 50px;
    }
    .content_register .el-input__inner::-webkit-input-placeholder{
          color:#FFFFFF;
     }
</style>
