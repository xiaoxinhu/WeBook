...
public class BookController {
   ...
   // private String basePath="D://ITsoftware//IDEA//data//Vue//book_01//";
    private  String basePath="//www//wwwroot//http//";
...
//
    ...
    public Map<String,Object> handlePut(@RequestParam(value = "bookId")int bookId,
        ...
        if(bookService.modifyBookPut(bookId,put)>0)
            return ResultUtil.resultCode(200,"修改成功");
        else return ResultUtil.resultCode(500,"修改失败");
    }
...
//    }
    ...
    public Map<String, Object> getSortBookListBySort(@RequestParam(value = "sortId")int sortId,
        ...
        if(bookSort.getUpperName().equals("无")){
            ...
            System.out.println(bookSort.getSortName()+"---"+page+"-----"+pageSize);
    ...
    @GetMapping(value = "/getBookListByName")
    //@RequestMapping(value = "/getBookListByName", method = RequestMethod.GET, produces="application/json;charset=utf-8" )
    public Map<String, Object>  getBookListByName(@RequestParam(value = "name")String name,
                                                     @RequestParam(value = "page")int page,
                                                     @RequestParam(value = "pageSize")int pageSize){
        System.out.println("**********");
        ...
        int total = 0;
        List<Book> bookList = new ArrayList<>();
        bookList =bookService.getBookByName(name,page,pageSize);
        System.out.println(bookList);
        for(int i=0;i<bookList.size();i++){
            String img = bookService.getBookCover(bookList.get(i).getIsbn());
            bookList.get(i).setCoverImg(img);
...
//        System.out.println("获取出来的bookSort:"+bookSort);
    ...
    public Map<String,Object> getBookImgPaths(@RequestParam(value = "isbn")String isbn){
        Map<String,Object> map = new HashMap<>();
    ...
    public Map<String,Object> delBook(@RequestParam(value = "bookId")int bookId){
        ...
        bookService.deleteBookImgOfOne(book.getIsbn());
