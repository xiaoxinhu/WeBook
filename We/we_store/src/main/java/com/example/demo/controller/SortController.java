...
import com.example.demo.model.dto.SortResponse;
...
//    }
     ...
     *
     */
    @GetMapping("/getEditBookSort")
    public Map<String,Object> getEditBookSort(@RequestParam int id){
        Map<String,Object> map = new HashMap<>();
        BookSort bookSort =sortService.getBookSortById(id);
        map.put("bookSort",bookSort);
        return ResultUtil.resultSuccess(map);
    }
    /**
